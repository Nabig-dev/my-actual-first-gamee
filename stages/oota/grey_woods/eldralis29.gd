...
func _ready() -> void :
	...
	VarsGlobal.GameInterface.start_dialog("elsa-event-a")
	...
	VarsGlobal.GameInterface.start_dialog("elsa-event-b")
...
func _on_KeyObject_obtained() -> void :
	VarsGlobal.GameInterface.start_dialog("elsa-event-c")
