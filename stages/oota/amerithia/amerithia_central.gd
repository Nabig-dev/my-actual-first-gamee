...
func go_to(opt: String) -> void :
	...
	match opt:
		"theorder":
			go_to_scene = "res://stages/oota/amerithia/the_order_entrance.tscn"
		"lab":
			go_to_scene = "res://stages/oota/amerithia/alchemy_lab.tscn"
		"store":
			go_to_scene = "res://stages/oota/amerithia/store.tscn"
		"library":
			VarsGlobal.current_room_changer = "dl"
			go_to_scene = "res://stages/oota/amerithia/library.tscn"
