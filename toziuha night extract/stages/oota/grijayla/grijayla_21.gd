...
func _ready() -> void :
	...
	if VarsGlobal.GameScenario.get_node_or_null("Witiko") != null:
		VarsGlobal.GameScenario.get_node("Witiko").gravity = 0
		VarsGlobal.GameScenario.get_node("Witiko").velocity = Vector2.ZERO

		VarsGlobal.GameScenario.get_node("Witiko").patterns.erase("laser")
		VarsGlobal.GameScenario.get_node("Witiko").patterns.erase("fireball")
	...
	if VarsGlobal.has_flag("witiko_grijayla_cinematic") == false:
		...
		VarsGlobal.GameScenario.get_node("BG/Parallax/BossWitiko/AnimWitikoPlay").play("witiko")
...
func _on_AnimWitikoPlay_animation_finished(_anim_name: String) -> void :
	...
	VarsGlobal.GameScenario.get_node("Witiko").get_node("Sprite").frame = 5
	VarsGlobal.GameScenario.get_node("Witiko").gravity = 1200
	VarsGlobal.GameScenario.get_node("Witiko").get_node("GhostTrail").start_trail()
	yield(get_tree().create_timer(1), "timeout")
	VarsGlobal.GameScenario.get_node("Witiko").gravity = 250
	...
	VarsGlobal.GameScenario.get_node("Witiko").get_node("GhostTrail").stop_trail()
