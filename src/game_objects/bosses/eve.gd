...
func _on_HurtboxEnemy_damaged() -> void :
	...
	if (
		...
		VarsGlobal.GameInterface.start_dialog("eve-phase2-1")
		...
		VarsGlobal.GameInterface.start_dialog("eve-phase2-2")
		yield(VarsGlobal.GameInterface, "dialog_ended")
		...
		VarsGlobal.GameInterface.start_dialog("eve-phase2-3")
		yield(VarsGlobal.GameInterface, "dialog_ended")
